...
For me, optics at was an introduction to signals and communication in disguise. Number theory introduced me to RSA, and got me thinking more deeply about cryptography in general and digital identity in particular. Once I started looking for a workable way to send a watermark-type signal from deployments to observers, my time spent with the _Essentials of Programming Languages (2nd Ed)_ by Friedman, Wand, and Haynes as an undergraduate at Case Western Reserve University made it trivially easy for me to recognize that adding a suffix to externally-supplied SHA256 input is a plausibly secure plaintext tagging construction.
